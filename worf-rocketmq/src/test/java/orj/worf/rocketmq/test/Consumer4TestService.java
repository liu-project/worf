...
@MQOrderConsumer(tags = "tag_test4", topic = "${mq.shardRepayTopic}", consumerId = "${mq.shardingConsumerId}")
public class Consumer4TestService implements MessageOrderListener {
